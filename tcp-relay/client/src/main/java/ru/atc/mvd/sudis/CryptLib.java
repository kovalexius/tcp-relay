package ru.atc.mvd.sudis.client;
...
//ref:http://stackoverflow.com/questions/14413169/which-java-library-provides-base64-encoding-decoding
...
public class CryptLib {
	 ...
	 */
		...
		if (_mode.equals(EncryptMode.ENCRYPT)) {
			...
			// For java 1.8
			_out = Base64.getEncoder().encodeToString(results);
